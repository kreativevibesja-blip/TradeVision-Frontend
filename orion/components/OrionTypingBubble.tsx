...
export function OrionTypingBubble() {
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: 10 }}
      className="max-w-[84%] rounded-[22px] rounded-bl-md border border-white/24 bg-[rgba(255,255,255,0.94)] px-4 py-3 text-[#4b5563] shadow-[0_10px_24px_rgba(17,24,39,0.12)]"
    >
