  ...
  return (
    <AnimatePresence>
      {open ? (
        ...
        >
          <div
            className="border-b border-violet-400 bg-gradient-to-r from-violet-500 to-indigo-500 px-4 py-3 text-white"
            style={{ background: 'linear-gradient(90deg, #8b5cf6 0%, #6366f1 100%)', color: '#ffffff', borderColor: '#a78bfa' }}
          >
          ...
          <div ref={scrollRef} className="flex-1 space-y-3 overflow-x-hidden overflow-y-auto bg-white px-3 py-3.5 text-slate-900" style={{ backgroundColor: '#ffffff', color: '#0f172a' }}>
            <div className="rounded-[16px] border border-violet-100 bg-violet-50 px-3 py-2.5 text-xs leading-5 text-violet-700" style={{ backgroundColor: '#f5f3ff', color: '#6d28d9', borderColor: '#ede9fe' }}>
              <span className="font-semibold text-violet-900" style={{ color: '#4c1d95' }}>{pageLabel}</span>
              <span className="text-violet-700" style={{ color: '#6d28d9' }}> · {pageSummary}</span>
            </div>
          ...
          <div className="border-t border-violet-100 bg-white px-3 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))]" style={{ backgroundColor: '#ffffff', borderColor: '#ede9fe' }}>
            <div className="flex items-end gap-3">
              ...
              <button
                ...
                style={{ background: 'linear-gradient(90deg, #8b5cf6 0%, #6366f1 100%)', color: '#ffffff' }}
              >
