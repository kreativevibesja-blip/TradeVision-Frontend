    ...
    <AnimatePresence>
      {open ? (
        <motion.div
          ...
          className="pointer-events-auto fixed bottom-4 right-4 z-[80] flex h-[min(82vh,760px)] w-[min(27rem,calc(100vw-1rem))] flex-col overflow-hidden rounded-[30px] border border-[rgba(96,165,250,0.22)] bg-[rgba(2,6,23,0.985)] shadow-[0_40px_120px_rgba(2,6,23,0.78),0_0_0_1px_rgba(59,130,246,0.12)] sm:bottom-6 sm:right-6 max-sm:inset-x-2 max-sm:bottom-2 max-sm:h-[min(78vh,calc(100dvh-1rem))] max-sm:w-auto max-sm:rounded-[28px]"
        >
          <div className="border-b border-blue-300/14 bg-[linear-gradient(180deg,rgba(15,23,42,0.98),rgba(8,15,31,0.98))] px-4 py-4 sm:px-5">
            ...
            <div className="mt-4 rounded-[22px] border border-white/8 bg-[rgba(15,23,42,0.96)] px-4 py-3">
          ...
          <div ref={scrollRef} className="flex-1 space-y-5 overflow-y-auto bg-[rgba(2,6,23,0.985)] px-4 py-4 sm:px-5">
          ...
          <div className="border-t border-blue-300/12 bg-[linear-gradient(180deg,rgba(8,15,31,0.98),rgba(2,6,23,0.995))] px-4 py-4 sm:px-5 pb-[calc(1rem+env(safe-area-inset-bottom))]">
            <div className="flex items-end gap-3">
              <textarea
                ...
                className="min-h-12 flex-1 resize-none rounded-[22px] border border-blue-300/16 bg-[rgba(15,23,42,0.96)] px-4 py-3 text-sm leading-6 text-white outline-none transition placeholder:text-white/32 focus:border-blue-300/34 focus:bg-[rgba(30,41,59,0.98)]"
              />
